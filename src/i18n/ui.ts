...
export const ui = {
  en: {
    ...
    "chatbot.lostPet.opt1": "📢 Report my lost pet",
    "chatbot.lostPet.opt2": "📍 How location tracking works",
    "chatbot.lostPet.opt3": "🧠 Tips to find a lost pet",
    "chatbot.back": "⬅️ Back to menu",
    ...
    "chatbot.foundPet.opt1": "📝 Report a found pet",
    "chatbot.foundPet.opt2": "🔍 Search lost pets nearby",
    "chatbot.foundPet.opt3": "What should I do meanwhile?",
    "chatbot.foundPetReport":
      "Create a found pet post so owners nearby can identify their pet.",
    "chatbot.foundPetSearch":
  ...
  es: {
    ...
    "chatbot.lostPet":
      "Lamento que estés pasando por esto 💙 ¿Qué te gustaría hacer?",
    "chatbot.lostPet.opt1": "📢 Reportar mi mascota perdida",
    "chatbot.lostPet.opt2": "📍 Cómo funciona el rastreo de ubicación",
    "chatbot.lostPet.opt3": "🧠 Consejos para encontrar una mascota perdida",
    "chatbot.back": "⬅️ Volver al menú",
    "chatbot.lostPetReport":
    ...
    "chatbot.foundPet":
      "Gracias por ayudar a una mascota necesitada 🐶 ¿Qué te gustaría hacer?",
    "chatbot.foundPet.opt1": "📝 Reportar una mascota encontrada",
    "chatbot.foundPet.opt2": "🔍 Buscar mascotas perdidas cerca",
    "chatbot.foundPet.opt3": "¿Qué debo hacer mientras tanto?",
    "chatbot.foundPetReport":
      "Crea una publicación de mascota encontrada para que los dueños cercanos puedan identificar a su mascota.",
    "chatbot.foundPetSearch":
